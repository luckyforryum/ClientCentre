...
public class AvatarUrls {
    ...
    @Autowired
    public AvatarUrls(
            @Value("http://localhost:65374/avatars/addAvatar") String SAVE,
            ...
            @Value("http://localhost:65374/avatars/delete/id") String DELETE_AVATAR_BY_ID,
            @Value("http://localhost:65374/avatars/delete/active") String DELETE_ACTIVE_AVATAR_BY_PI
    ) {
