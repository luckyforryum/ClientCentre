...
(
    ...
    message         varchar(255),
    name            varchar(255),
    numberRFP       varchar(255) not null,
    passport_status varchar(255),
    patronymic      varchar(255),
    receipt_date    date,
    seriesRFP       varchar(255) not null,
    surname         varchar(255),
    validate_date   date,
...
(
    ...
    message         varchar(255),
    name            varchar(255),
    numberFP        varchar(255) not null,
    passport_status varchar(255),
    patronymic      varchar(255),
    receipt_date    date,
    seriesFP        varchar(255) not null,
    surname         varchar(255),
    validate_date   date,
    document_id     varchar(255)
...
(
    ...
    message       varchar(255),
    name          varchar(255),
    numberRDL     varchar(255) not null,
    patronymic    varchar(255),
    receipt_date  date,
    seriesRDL     varchar(255) not null,
    surname       varchar(255),
    validate_date date,
    document_id   varchar(255)
