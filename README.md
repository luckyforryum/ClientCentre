...
Схема базы данных - [Схема](https://clientprofile.kaiten.ru/space/142540/card/10496666)
...
Таск-борд находится прямо на [Kaiten](https://clientprofile.kaiten.ru/space/142540).

Dev-stand будем поднимать и разворачивать через Docker, а настраивать CI/CD - через Github.
...
## Структура проекта
### ERD
Диаграмма связей сущностей: [Взаимодействие](https://clientprofile.kaiten.ru/space/142540/card/10496668)
### Бэкенд
...
<li>изучи <a href="https://clientprofile.kaiten.ru/space/142539">таск-борд</a>
</ol>


### О таскборде

Таск-борд строится по принципу Agile - он разделён на столбцы, каждый из которых соответствует определённому этапу работы с задачей:
<ul>
...
https://clientprofile.kaiten.ru/space/142540/card/10496792
https://clientprofile.kaiten.ru/space/142540/card/10496828
https://clientprofile.kaiten.ru/space/142540/card/10496829
### 